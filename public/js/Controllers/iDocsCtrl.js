...
angular.module('accounts', [ 'ngMaterial' ])
     .controller('iDocsCtrl', ['iDocsService', '$mdBottomSheet', '$mdSidenav', iDocsCtrl ])
     .service('iDocsService', ['$q', iDocsService]);

// Accounts Controller for the Angular Material Start

function iDocsCtrl( iDocsService, $mdBottomSheet, $mdSidenav ) {
    var self = this;
